...
"""ADW Plan Build Test — plan, implement, verify; failures flow back into the builder.

Usage:
    uv run adws/adw_plan_build_test.py "<prompt or path/to/prompt.md>" [--config adws/config/sssf.config.yaml] [--adw-id a1b2c3d4]

Phases: engineer(request) -> planner -> builder -> code(test) [-> builder(fix) ... bounded] -> git(commit)"""
